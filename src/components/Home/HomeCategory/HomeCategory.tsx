...
import styles from './home-category.sass';
...
export default component$((props: Category) => {
    useStylesScoped$(styles);

    return (
        <div class={props.useBg ? 'product-category has-bg' : 'product-category'} style={props.useBg ? `--category-bg:url('${props.categoryBg}')` : ''}>
            <h4 class="category-title">{props.title}</h4>
            ...
            <Link href="#!" class="browse-all">Browse All {props.title}</Link>
        </div>
    );
});
